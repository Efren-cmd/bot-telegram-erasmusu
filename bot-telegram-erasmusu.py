...
def start(update, context):
    reply_keyboard = [[InlineKeyboardButton('ES', callback_data='1'), InlineKeyboardButton('EN', callback_data='EN')]]
...
def menu(update, context):
    ...
    reply_keyboard = [[InlineKeyboardButton('ES', callback_data='1'), InlineKeyboardButton('EN', callback_data='ES')]]
    reply_markup = InlineKeyboardMarkup(reply_keyboard)
    update.message.reply_text(
    "Hi, please select a language to start. / Hola, por favor selecciona un idioma para comenzar.",
        reply_markup=reply_markup)
